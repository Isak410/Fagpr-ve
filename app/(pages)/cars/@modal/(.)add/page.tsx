...
export default function AddCarModal() {
    ...
    return (
        <div
            onClick={() => router.back()}
            className="z-40 fixed inset-0 flex items-center justify-center bg-gray-300/50"
        >
            <div
                onClick={(e) => e.stopPropagation()}
                className={`bg-white rounded-xl p-6 shadow-xl w-full max-w-md transform transition-transform duration-300 ${
